...
describe("typeguards", () => {
  ...
  test("isFullSlug", () => {
    ...
    assert(path.isFullSlug("test.md.pdf"))
  ...
  test("isFilePath", () => {
    ...
    assert(path.isFilePath("content/test.md.png"))
    assert(!path.isFilePath("../test.md.pdf"))
    assert(!path.isFilePath("content/test.md"))
    assert(!path.isFilePath("./content/test.md"))
  })
})
  ...
  test("transformInternalLink", () => {
    asserts(
      [
        ...
        ["./index.css", "./index.css"],
        ["content", "./content"],
        ["content/test.md.md", "./content/test.md"],
        ["content/test.md.pdf", "./content/test.md.pdf"],
        ["./content/test.md.md", "./content/test.md"],
        ["../content/test.md.md", "../content/test.md"],
        ["tags/", "./tags/"],
        ["/tags/", "./tags/"],
...
describe("link strategies", () => {
  ...
  describe("absolute", () => {
    ...
    test("from a/b/c", () => {
      ...
      assert.strictEqual(path.transformLink(cur, "tag/test.md", opts), "../../tag/test.md")
      assert.strictEqual(path.transformLink(cur, "a/b/c#test.md", opts), "../../a/b/c#test.md")
      assert.strictEqual(path.transformLink(cur, "a/test.md.png", opts), "../../a/test.md.png")
    })
  ...
  describe("shortest", () => {
    ...
    test("from a/b/c", () => {
      ...
      assert.strictEqual(path.transformLink(cur, "index", opts), "../../")
      assert.strictEqual(path.transformLink(cur, "index.png", opts), "../../index.png")
      assert.strictEqual(path.transformLink(cur, "test.md.png", opts), "../../a/test.md.png")
      assert.strictEqual(path.transformLink(cur, "index#abc", opts), "../../#abc")
    })
  ...
  describe("relative", () => {
    ...
    test("from a/b/c", () => {
      ...
      assert.strictEqual(
        path.transformLink(cur, "../../../a/test.md.png", opts),
        "../../../a/test.md.png",
      )
      assert.strictEqual(path.transformLink(cur, "../../../e/g/h", opts), "../../../e/g/h")
      assert.strictEqual(path.transformLink(cur, "../../../e/g/h", opts), "../../../e/g/h")
